...
if(($n=="root")||($n=="fokam"))
  if(!($m=="fokam")){
      ...
      echo"<br><a href="."utilisateur.php"." target="."utilisateur"."><blink>précédent</blink></a><br><br>";
  } 
  else{
...
if(!(($n=="socale")||($n=="casimir"))) 
{
 ...
 {
      echo"<br><a href="."utilisateur.php"." target="."utilisateur"."><blink>précédent</blink></a><br><br>";
      echo"Connection à la base impossible!<br><blink><font color="."red"."><i>Login ou mot de passe incorrecte!</i></font><blink>";
}
 else{
  if($n=="casimir"){
    echo"c moi";
