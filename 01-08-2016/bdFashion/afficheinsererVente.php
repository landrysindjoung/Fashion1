...
//  $table=getChamps("vendeur","idvendeur");
   ...
   //$c=$_REQUEST['idvendeur'];
      ...
      if($n<=0){ echo"<font color=\"red\"><blink>Vérifier la quantité entrée!</blink></font>";
       echo"<br><br><tr><td align=\"left\"> <br><a href=\"insererVente1.php\">retour</a></td>";}
      else{
...
//                 echo "<FONT color=\"red\"><h1><b>CONTINUER  LA FACTURATION</b></h1></font>";
  ...
  <form action="insererVente2.php" method="post">
  ...
  while($ligne=mysql_fetch_row($tab))
    ...
    echo "</select></td></tr>";
	?>
    <br><br><tr><td align="left"> <br><div align="right"><a href="genererfacture.php">Générer la facture</a></td>
    <td colspan=2 align="right"><input type="submit" name="submit" value="Continuer"></td>
    </tr></form>
