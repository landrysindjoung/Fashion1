...
<?php   
  ...
  ?>
  <form action="afficheModifierPrixEntree.php" method="post">    
  <?php
  ...
  while($ligne=mysql_fetch_row($tab))
    ...
    echo "</select></td></tr>";
	?>
    <tr><td>ancien prix</td>   <td><input type="text" name="ancien" value="0" ></td></tr>         
    <tr><td>nouveau prix</td>   <td><input type="text" name="nouveau1" value="0" ></td></tr>          
    <tr><td>confirmer nouveau prix</td>   <td><input type="text" name="nouveau2" value="0" ></td></tr>          
